    ...
    <section className="py-24 bg-gradient-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          <Card className="p-8 bg-white/10 backdrop-blur-sm border-white/20 text-foreground">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-patriot-blue">Maximize Voter Reach</h3>
            </div>
          ...
          <Card className="p-8 bg-white/10 backdrop-blur-sm border-white/20 text-foreground">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-patriot-blue">Stay FEC Compliant</h3>
            </div>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <Card className="p-8 bg-white/10 backdrop-blur-sm border-white/20 text-foreground">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-patriot-blue">Measure Impact</h3>
            </div>
            <p className="text-foreground/80 leading-relaxed">
        ...
        <div className="text-center">
          <Button variant="pulse" size="lg" className="text-lg px-12 py-4 bg-patriot-blue text-foreground hover:bg-patriot-blue/90">
            Schedule PAC Demo
          </Button>
        </div>
      </div>
